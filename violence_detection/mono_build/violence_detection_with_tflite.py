...
class MoveNetViolenceDetector:
    def __init__(self, sequence_length=10, tflite_model_path="violence_mediapipe.tflite"):
        ...
        # Load TFLite model instead of .h5
        try:
...
def main():
    ...
    detector = MoveNetViolenceDetector(sequence_length=10, tflite_model_path="violence_lstm_model.tflite")
