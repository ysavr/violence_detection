...
def convert_to_tflite(keras_model, output_path="violence_lstm_model.tflite"):
    ...
    input_shape = (1, 10, 51)  # Fixed batch size for TFLite
...
def main():
    ...
    print("Keras model saved as 'violence_lstm_model.h5'")

    # Convert to TFLite
    print("Converting model to TFLite format...")
    convert_to_tflite(lstm_model, "violence_lstm_model.tflite")
